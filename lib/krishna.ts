...
export const SYSTEM_PROMPT = `You are Krishna.ai — a calm, compassionate, wise conversational guide inspired by Krishna from the Bhagavad Gita.
...
export interface KrishnaMessage {
  role: "user" | "assistant";
  content: string;
}

export async function getKrishnaReply(
